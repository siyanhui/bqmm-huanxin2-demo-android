...
public class MessageAdapter extends BaseAdapter {
    ...
    private Map<String, SpannableStringBuilder> msgSpannableMap = new HashMap<String, SpannableStringBuilder>();
            ...
            if (message.getType() == EMMessage.Type.IMAGE) {
                ...
                try {
                    ...
                    holder.iv_avatar = (ImageView) convertView
                            .findViewById(R.id.iv_userhead);
                    // 这里是文字内容
//                    holder.bv_messageview = (BQMMMessageView) convertView.findViewById(R.id.bv_messageview);
                    holder.bqmm_message_tv = (BQMMMessageText) convertView.findViewById(R.id.bqmm_message_tv);
                    holder.tv_usernick = (TextView) convertView
                            .findViewById(R.id.tv_userid);
     ...
     * @param position
     */
    private void handleTextMessage(final EMMessage message,
    ...
    private void handleImageMessage(final EMMessage message,
        ...
        if (message.direct == EMMessage.Direct.RECEIVE) {
            ...
            if (message.status == EMMessage.Status.INPROGRESS) {
                // "!!!! back receive";
                holder.iv.setImageResource(R.drawable.icon_emoticon_loading);
...
//        ImageView tv_pic;
//        GifMovieView tv_gif;
//        BQMMMessageView bv_messageview;
        BQMMMessageText bqmm_message_tv;
